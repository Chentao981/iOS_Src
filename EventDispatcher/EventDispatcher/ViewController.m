...
- (void)viewDidLoad {
    ...
    //添加事件监听
    [obj addEventListenerWithType:eventType andTarget:self andAction:@selector(onClickHandler1:) andPriority:1];
    ...
    [obj addEventListenerWithType:eventType andTarget:self andAction:@selector(onClickHandler4:) andPriority:2];
    ...
    //移除一个监听器
    [obj removeEventListenerWithType:eventType andTarget:self action:@selector(onClickHandler4:)];
