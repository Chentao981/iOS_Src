...
-(void)dispatchEvent:(CEvent *)event{
    ...
    CEventPriority *eventPriority = [[self eventListeners]objectForKey:eventType];
    if (eventPriority) {
...
-(void)removeAllEventListener{
    objc_setAssociatedObject(self, &EVENT_LISTENERS, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
